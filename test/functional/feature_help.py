...
"""Verify that starting topaz with -h works as expected."""

from test_framework.test_framework import TOPAZTestFramework
from test_framework.util import assert_equal

class HelpTest(TOPAZTestFramework):
    ...
    def run_test(self):
        self.log.info("Start topaz with -h for help text")
        ...
        self.log.info("Start topaz with -version for version information")
        ...
        self.log.info("Start topazd with -fakearg to make sure it does not start")

...
class BIP66Test(TOPAZTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # topazd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and topazd produces more specific reject
            # reasons.

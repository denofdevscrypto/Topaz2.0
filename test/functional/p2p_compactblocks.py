...
# TestP2PConn: A peer we use to send messages to topazd, and store responses.
...
class CompactBlocksTest(TOPAZTestFramework):
    ...
    # This test actually causes topazd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that topazd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for topazd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # topazd will not send blocktxn responses for blocks whose height is

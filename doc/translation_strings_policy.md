...
This document provides guidelines for internationalization of the TOPAZ Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `topaz_en.ts` remains unchanged.

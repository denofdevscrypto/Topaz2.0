...
* topaz.conf: contains configuration settings for topazd or topaz-qt
* topazd.pid: stores the process id of topazd while running
...
* debug.log: contains debug information and general logging generated by topazd or topaz-qt

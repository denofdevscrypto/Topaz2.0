...
#ifndef TOPAZ_QT_TOPAZUNITS_H
#define TOPAZ_QT_TOPAZUNITS_H
...
/** TOPAZ unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TOPAZUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TOPAZUnits(QObject *parent);

    /** TOPAZ units.
      @note Source: https://en.topaz.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TOPAZ,
...
typedef TOPAZUnits::Unit TOPAZUnit;

#endif // TOPAZ_QT_TOPAZUNITS_H

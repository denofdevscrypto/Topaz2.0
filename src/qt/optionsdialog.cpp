    ...
    mapper(0)
{
    ...
    ui->topazAtStartup->setToolTip(ui->topazAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->topazAtStartup->setText(ui->topazAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTOPAZConfButton->setToolTip(ui->openTOPAZConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TOPAZUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->topazAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTOPAZConfButton_clicked()
{

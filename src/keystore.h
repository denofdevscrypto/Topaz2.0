...
#ifndef TOPAZ_KEYSTORE_H
#define TOPAZ_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/topaz/bips/blob/master/bip-0013.mediawiki

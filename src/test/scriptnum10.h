...
#ifndef TOPAZ_TEST_SCRIPTNUM10_H
#define TOPAZ_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from TOPAZ Core 0.10.0, for cross-comparison.
 */
public:

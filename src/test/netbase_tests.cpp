...
{
    BOOST_CHECK(TestSplitHost("www.topazcore.org", "www.topazcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.topazcore.org]", "www.topazcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.topazcore.org:80", "www.topazcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.topazcore.org]:80", "www.topazcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8868", "127.0.0.1", 8868));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8868", "127.0.0.1", 8868));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8868", "::ffff:127.0.0.1", 8868));
    BOOST_CHECK(TestSplitHost("[::]:8868", "::", 8868));
    BOOST_CHECK(TestSplitHost("::8868", "::8868", -1));
    BOOST_CHECK(TestSplitHost(":8868", "", 8868));
    BOOST_CHECK(TestSplitHost("[]:8868", "", 8868));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8868", "127.0.0.1:8868"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8868", "[::]:8868"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
